...
<main>
  <div id="portfolio" class="xl:px-32 w-screen pt-32">
    <div class="flex lg:gap-16 gap-6 items-center justify-center">
      <div
    ...
    >
      ...
      <div class="flex w-3/4 flex-col lg:items-start items-center gap-6">
    ...
    >
      {#if width < 768}
        <div class="w-52 h-52 rounded-lg bg-dark-white" />
      {/if}
      <div class="flex w-3/4 flex-col justify-center gap-6">
